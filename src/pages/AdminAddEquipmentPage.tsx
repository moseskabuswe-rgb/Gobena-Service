...
export default function AdminAddEquipmentPage() {
  ...
  const reset = () => {
    ...
    setForm({
      shop_id: form.shop_id, // keep shop selected
      name: '',
      category: '',
      model: '',
      serial_number: '',
      ...
      <main className="max-w-lg mx-auto px-4 py-10 space-y-6">
        <div className="card text-center py-10 space-y-4">
          ...
          <div className="flex flex-col gap-2 pt-2">
            <button
              onClick={() => navigate(`/equipment/${newEquipmentId}`)}
            ...
            <button
              ...
              className="text-sm text-roast-400 hover:text-bark transition-colors mt-1"
            >
      ...
      <form onSubmit={handleSubmit} className="card space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            placeholder="Any setup notes, warranty info, special instructions…"
